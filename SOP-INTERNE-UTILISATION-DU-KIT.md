...
> Lis le noyau, les deux références RSPIR, le manifeste et le contrat des commandes. Exécute seulement la commande actuellement autorisée. Si une entrée manque, inscris exactement laquelle et arrête-toi. Ne commence pas la commande suivante.
