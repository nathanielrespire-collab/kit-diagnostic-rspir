...
Copy-Item -LiteralPath (Join-Path $PSScriptRoot 'REFERENCES-RSPIR\CONFIGURATION-DONNEES-ET-OUTILS.md') -Destination $referenceTarget
Copy-Item -LiteralPath (Join-Path $PSScriptRoot 'REFERENCES-RSPIR\MARQUE-RSPIR') -Destination $referenceTarget -Recurse
